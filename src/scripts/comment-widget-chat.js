...
const s_stylePath = 'styles/comment-widget-chat.css';
const s_formId = '1FAIpQLSe5UwEth6_BiRgURH0ZLKnR5iG4pYiWku1Xx3pKvvJb8t6HqQ';
const s_nameId = '1033754338';
const s_websiteId = '1545858477';
const s_textId = '1352197441';
const s_pageId = '1272139395';
const s_replyId = '1692642874';
const s_sheetId = '1PUny40wMwIFL88y04D7I6TljW2jUG9-7B5Yx8kG0TCs';
...
const s_dstStart = ['March', 'Sunday', 4, 2]; // Example shown is the second Sunday of March at 2:00 am
const s_dstEnd = ['October', 'Sunday', 4, 2]; // Example shown is the first Sunday of November at 2:00 am
